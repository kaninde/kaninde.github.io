...
Ao baixar, instalar, acessar ou usar o aplicativo **Pocket Color Lighting Studio (PCLS)** (“Aplicativo”), você (“Usuário”) declara que leu, entendeu e concorda com estes Termos e Condições. Se não concordar, não utilize o Aplicativo.

---

## 2. Alterações e atualizações

Podemos atualizar o Aplicativo e/ou estes Termos periodicamente. O uso continuado após alterações significa que aceita os Termos atualizados.

---

## 3. Uso permitido

O Aplicativo destina-se a uso **pessoal e não comercial**, salvo autorização nossa por escrito. Você concorda em não:

- Usar o Aplicativo para fins ilegais;
- Tentar perturbar, fazer engenharia reversa além do permitido por lei ou abusar do Aplicativo.
...
Recursos opcionais podem ligar-se a URLs de **terceiros** (por exemplo JSON remoto para atualização de catálogos ou carrossel de outras apps), **redes de anúncios**, **serviços opcionais de tradução** ou faturação na **loja de aplicativos**. Esses serviços regem-se pelos próprios termos. Não somos responsáveis por conteúdo, disponibilidade ou exatidão de terceiros.
...
## 8. Pagamentos e subscrições (se aplicável)

Se o Aplicativo oferecer funções pagas, as compras estão sujeitas aos termos da **loja de aplicativos** aplicável. Reembolsos apenas onde exigido por lei ou política da loja.
