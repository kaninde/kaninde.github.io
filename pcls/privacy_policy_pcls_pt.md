...
Esta Política de Privacidade descreve como o **Pocket Color Lighting Studio** (“PCLS”, “Aplicativo”) trata informações no seu dispositivo e, quando você usa certas funções, interações limitadas pela internet.

Ao usar o Aplicativo, você concorda com as práticas descritas nesta Política de Privacidade.

Estamos comprometidos em proteger a sua privacidade e ser transparentes sobre o tratamento de dados.
...
- O Aplicativo **não exige** a criação de conta para o fluxo local principal.
...
Com conectividade, o Aplicativo pode ligar-se à internet, por exemplo para:
...
Conforme a plataforma, o Aplicativo pode pedir, entre outras:
...
O Aplicativo pode depender de terceiros, incluindo publicidade, pagamentos na loja da plataforma, hospedeiros de ficheiros de catálogo ou configuração remotos e serviços opcionais de tradução, cada um com os seus termos e políticas de privacidade.
...
Adotamos práticas razoáveis, mantendo conteúdo de iluminação **no dispositivo** por defeito e minimizando recolha desnecessária.

Você é responsável por proteger o dispositivo e manter o sistema atualizado.
...
Podemos atualizar esta Política periodicamente. A data de “Última atualização” mudará. O uso continuado após alterações constitui aceitação da política revista.
