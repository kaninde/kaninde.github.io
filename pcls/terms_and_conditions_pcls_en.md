...
By downloading, installing, accessing, or using the **Pocket Color Lighting Studio (PCLS)** application (“Application”), you (“User”) confirm that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree, do not use the Application.

---

## 2. Changes and updates

We may update the Application and/or these Terms from time to time. Continued use after changes means you accept the updated Terms.

---

## 3. Permitted use

The Application is provided for **personal, non-commercial** use unless otherwise allowed by us in writing. You agree not to:

- Use the Application for unlawful purposes;
- Attempt to disrupt, reverse engineer beyond what the law permits, or abuse the Application.
...
Optional features may connect to **third-party** URLs (for example remote JSON for catalog updates or an “other apps” carousel), **advertising networks**, **optional translation services**, or **app store** billing. Those services are governed by their own terms. We are not responsible for third-party content, availability, or accuracy.
...
If the Application offers paid features, purchases are subject to the applicable **app store’s** terms. Refunds are only provided where required by law or store policy.
