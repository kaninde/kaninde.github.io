# Terms and Conditions of Use - TaPago
...
By downloading, installing, accessing, or using the **TaPago** application (“Application”), you (“User”) confirm that you have read, understood, and agree to be legally bound by these Terms and Conditions of Use. If you do not agree to any part, the use of the Application is strictly prohibited.
...
The User agrees that, when using the Application to transmit or share check-in or progress tracking data with third parties, they assume full responsibility for any damages, losses, or disputes caused to third parties or others, directly or indirectly.
...
- Impacts caused to third parties due to misinterpretation or misuse of the data provided by the Application.
...
**NOTICE:**
By using **TaPago**, you confirm that you have read, understood, and agree to all the Terms and Conditions described. Use of the Application implies full acceptance, including responsibility for any data shared with third parties and adherence to confidentiality provisions.
